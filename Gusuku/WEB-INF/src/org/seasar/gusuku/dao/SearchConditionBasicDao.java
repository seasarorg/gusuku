...
@S2Dao(bean=SearchConditionBasic.class)
public interface SearchConditionBasicDao {

	public void insert(SearchConditionBasic searchConditionBasic);
	public void update(SearchConditionBasic searchConditionBasic);
