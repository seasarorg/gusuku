...
@S2Dao(bean=MailCondition.class)
public interface MailConditionDao {
	
	public void insert(MailCondition mailCondition);
	public void update(MailCondition mailCondition);
	public void delete(MailCondition mailCondition);
